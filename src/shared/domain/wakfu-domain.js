 ...
 */
export const BREED_TO_CLASS_MAP = new Map([
    [8, 'Iop'],
    [9, 'Cra'],
 ...
 */
export function breedToClass(breed) {
...
export class ClassDetector {
     ...
     */
    static getSpellsForClass(classType) {
        switch (classType) {
            case 'Iop':
 ...
 */
export const IOP_SPELL_COST_MAP = new Map([
    ["Épée céleste", "2PA"],
    ["Fulgur", "3PA"],
    ["Super Iop Punch", "4PA"],
    ["Jugement", "1PA"],
...
export const IOP_SPELL_ICON_MAP = new Map([
...
//# sourceMappingURL=wakfu-domain.js.map