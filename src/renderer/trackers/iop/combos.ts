...
class IopCombosTracker {
  private comboDefinitions: ComboDefinition[] = [
    ...
    { name: "Dommages supplémentaires", steps: ["2PA", "1PA", "1PM"], icon: "combo4.png" },
    { name: "Combo PA", steps: ["1PW", "3PA", "1PW", "1PA"], icon: "combo5.png" }
  ];
  ...
  private updateUI(): void {
    for (const combo of this.comboDefinitions) {
      ...
      for (let i = 0; i < combo.steps.length; i++) {
        ...
        step.classList.remove('completed', 'next-step', 'future', 'animating-out');
